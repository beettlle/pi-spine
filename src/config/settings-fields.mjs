...
export const SETTINGS_FIELDS = Object.freeze([
	...
	{
		path: "agents.reviewer.plan.thinking",
		label: "Plan reviewer thinking level",
		type: "enum",
		enum: ["off", "low", "medium", "high", "inherit"],
	},
	{
		path: "agents.reviewer.code.model",
		label: "Code reviewer model",
		type: "string",
		optional: true,
	},
	{
		path: "agents.reviewer.code.thinking",
		label: "Code reviewer thinking level",
		type: "enum",
		enum: ["off", "low", "medium", "high", "inherit"],
	},
	{
		path: "agents.reviewer.final.model",
		label: "Final reviewer model",
		type: "string",
		optional: true,
	},
	{
		path: "agents.reviewer.final.thinking",
		label: "Final reviewer thinking level",
		type: "enum",
		enum: ["off", "low", "medium", "high", "inherit"],
	},
	{
