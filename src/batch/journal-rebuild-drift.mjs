// @ts-nocheck
/**
 * Batch-state drift detect/reconcile and done-marker helpers (FR-STA-01, #170/#190).
 * Structural derivation lives in journal-rebuild-structural.mjs (SP-584).
 * Public API remains journal-rebuild.mjs re-exports (SP-602).
 */
