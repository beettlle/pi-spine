...
| SP-541 | contract-verify npm guard | Done | SP-540 | #187 |
...
- [x] contract-verify refuses `npm test --` at runtime (SP-541)
...
| Task | Summary | Status | Deps | Issue |
|------|---------|--------|------|-------|
| SP-565 | v2.2.0 handoff PRD | Done | — | — |
| SP-566 | release manifest | Done | SP-565 | — |
| SP-567 | regression gate script | Done | SP-566 | — |
| SP-568 | done-marker explore (#190) | Done | SP-566 | #190 |
| SP-569 | done-marker fail-closed engine | Done | SP-568 | #190 |
| SP-570 | operator salvage list | Done | SP-567 | #158 |
| SP-571 | operator salvage integrate | Done | SP-570 | #158 |
| SP-572 | GitHub backlog hygiene | Done | SP-569, SP-571 | hygiene |
| SP-573 | CONTEXT Phase 64 capstone | Done | SP-565–572 | — |
...
**Phase 66 implementation complete (SP-608–612).** Publish (`npm version patch` → v2.3.1) remains operator-gated. Manifest: [`spine-tasks/_authoring/release-v2.3.1/manifest.md`](_authoring/release-v2.3.1/manifest.md). Deferred: #193 was pulled into Phase 67 (operator override).

### Phase 67 — v2.3.2 state-drift recovery (SP-REL232)

**PRD:** [`docs/PRD-v2.3.2-state-drift-recovery-handoff.md`](../docs/PRD-v2.3.2-state-drift-recovery-handoff.md)  
**Manifest:** [`spine-tasks/_authoring/release-v2.3.2/manifest.md`](_authoring/release-v2.3.2/manifest.md)  
**Operator approved scope:** yes (2026-07-11). Enhancement override: #193 in patch.
...
**Wave plan:** Wave 0 parallel SP-613, SP-614, SP-616; Wave 1 SP-615 + SP-617; Cap SP-618.
...
**Profile:** minor — docs-shaped #282/#281 + enh #278/#279. Bugs: 0 (operator override — none open). Operator approved scope 2026-09-04. Worker pin: `zai/glm-5.3-flash` / `activeProfile: default` (pre-execution switch from allegretto).

| Task | Mission | Size | Issue | Status |
|------|---------|------|-------|--------|
| SP-743 | Operator handoff quality bar (runbook + operator rule) | S | #282 | Done |
| SP-744 | Disambiguate PROMPT Assessment → Risk / Problem theory | S | #281 | Done |
| SP-745 | Diagnose `background[]` + `assessmentReason` | M | #278 | Done |
| SP-746 | issue-draft / handoff SBAR-shaped sections | M | #279 | Done |

**Phase 87 exit criteria:**

- [x] Operator approved scope (2026-09-04)
- [x] SP-743–SP-746 `.DONE` and integrated on `main`
- [x] Post-integrate `release:check` green after wave 0 (LOC split `2c1a2abd`; `/tmp/pi-spine-post-integrate-wave-0-retry.log`)
- [x] Post-integrate coverage gate green after wave 1 (`/tmp/pi-spine-coverage-check-retry.log` — #222 isolation 90.46%)
- [x] #282, #281, #278 closed when wave 0 landed; #279 closed when wave 1 landed
- [x] CI green on pre-bump HEAD `58d1aa79` ([33916294750](https://github.com/beettlle/pi-spine/actions/runs/33916294750))
