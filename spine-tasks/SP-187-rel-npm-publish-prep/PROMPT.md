...
**Assessment:** Phase 22 reliability epic (SP-REL-017).
**Score:** 2/8 — Blast radius: 1, Pattern novelty: 0, Security: 0, Reversibility: 1

## Mission

Release checklist and package.json publish fields.
...
- [ ] Read handoff entry for SP-187
- [ ] Dependencies satisfied

### Step 1: Implement

- [ ] Deliver mission scope for SP-187
...
- [ ] All steps complete
- [ ] Handoff §4 acceptance for SP-187

## Git Commit Convention

- `feat(SP-187): complete Step N — description`
