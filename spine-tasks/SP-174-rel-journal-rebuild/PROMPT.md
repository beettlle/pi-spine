# Task: SP-174 — Journal rebuild core
...
**Assessment:** Phase 22 reliability epic (SP-REL-004).
**Score:** 6/8 — Blast radius: 2, Pattern novelty: 1, Security: 0, Reversibility: 1

## Mission

Implement rebuildBatchStateFromJournal() applying events to task/segment rows.
...
- [ ] Read handoff entry for SP-174
- [ ] Dependencies satisfied

### Step 1: Implement

- [ ] Deliver mission scope for SP-174
...
- [ ] All steps complete
- [ ] Handoff §4 acceptance for SP-174

## Git Commit Convention

- `feat(SP-174): complete Step N — description`
