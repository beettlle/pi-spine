# Task: SP-190 — Handoff autoWriteOn
...
**Assessment:** Phase 22 reliability epic (SP-REL-020).
**Score:** 4/8 — Blast radius: 1, Pattern novelty: 1, Security: 0, Reversibility: 1

## Mission

handoff.autoWriteOn session_start + /spine entry hook.
...
- [ ] Read handoff entry for SP-190
- [ ] Dependencies satisfied

### Step 1: Implement

- [ ] Deliver mission scope for SP-190
...
- [ ] All steps complete
- [ ] Handoff §4 acceptance for SP-190

## Git Commit Convention

- `feat(SP-190): complete Step N — description`
