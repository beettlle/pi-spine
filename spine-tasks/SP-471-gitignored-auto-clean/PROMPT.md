...
| Field | Value |
|-------|-------|
| testCommand | `npm run typecheck && SPINE_WORKER_STUB=1 npm test -- tests/batch/gitignored-auto-clean.test.mjs && npm run coverage:check && scripts/spine-stet-contract-run.sh lenient` |
| minLineCoverage | 77 |
