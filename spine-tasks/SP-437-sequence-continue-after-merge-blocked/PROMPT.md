...
| Field | Value |
|-------|-------|
| testCommand | `npm run typecheck && SPINE_WORKER_STUB=1 npm test -- tests/batch/sequence-merge-blocked-continue.test.mjs && npm run coverage:check && stet start HEAD --allow-dirty --quiet && stet run --strictness lenient --auto-finish-zero --quiet` |
| minLineCoverage | 77 |
