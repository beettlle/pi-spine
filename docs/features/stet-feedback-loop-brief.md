...
- [x] "State & feedback loop" subsection in `docs/stet-overview.md` (link here)
- [x] Extend operator runbook §8.1: when `history.jsonl` appears, triage before auto-finish clears findings, `stet stats` / `stet optimize` cadence
