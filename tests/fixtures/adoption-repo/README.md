...
Spine config (`.spine/spine-config.json`) is **not** checked in — bootstrap runs `spine init` on first use. See [bootstrap-checklist.md](../../../docs/adoption/bootstrap-checklist.md).
